    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          Unapproved Employer Account List
        </Typography>
      )}
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_HOST + "api/admins/get_unapproved_employers")
      .then((response) => {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.company_size}</TableCell>
